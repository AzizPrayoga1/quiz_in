 ...
 * Use the [soal10Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class soal10Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSoal10Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun lanjutKeSoal11() {
        val bundle = Bundle().apply {
            putInt("benar", benar)
        }
        val nextFragment = soal11Fragment()
    ...
    companion object {
         ...
         * @return A new instance of fragment soal10Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            soal10Fragment().apply {
