 ...
 * Use the [soal56Fragment.newInstance] factory method to
...
class soal56Fragment : Fragment() {
    ...
    private fun lanjutKeSoal57() {
        val bundle = Bundle().apply {
            putInt("benar", benar)
        }
        val nextFragment = soal57Fragment()
    ...
    companion object {
         ...
         * @return A new instance of fragment soal56Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            soal56Fragment().apply {
