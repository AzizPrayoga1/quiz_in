...
class soal32Fragment : Fragment() {
    ...
    private var _binding: FragmentSoal32Binding? = null
    ...
    private fun lanjutKeSoal33() {
        val bundle = Bundle().apply {
            putInt("benar", benar)
        }
        val nextFragment = soal33Fragment()
    ...
    companion object {
         ...
         * @return A new instance of fragment soal32ragment.
         */
