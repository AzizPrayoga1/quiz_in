...
class soal53Fragment : Fragment() {
    ...
    private var _binding: FragmentSoal53Binding? = null
    ...
    private fun lanjutKeSoal54() {
        val bundle = Bundle().apply {
            putInt("benar", benar)
        }
        val nextFragment = soal54Fragment()
    ...
    companion object {
         ...
         * @return A new instance of fragment soal53Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            soal53Fragment().apply {
