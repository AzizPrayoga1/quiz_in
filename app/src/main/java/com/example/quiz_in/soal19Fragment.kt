...
import com.example.quiz_in.databinding.FragmentSoal19Binding
 ...
 * Use the [soal19Fragment.newInstance] factory method to
...
class soal19Fragment : Fragment() {
    ...
    private fun lanjutKeSoal20() {
        val bundle = Bundle().apply {
            putInt("benar", benar)
        }
        val nextFragment = soal20Fragment()
    ...
    companion object {
         ...
         * @return A new instance of fragment soal19Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            soal19Fragment().apply {
