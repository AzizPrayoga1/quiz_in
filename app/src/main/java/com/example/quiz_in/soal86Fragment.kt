 ...
 * Use the [soal86Fragment.newInstance] factory method to
...
class soal86Fragment : Fragment() {
    ...
    private fun lanjutKeSoal87() {
        val bundle = Bundle().apply {
            putInt("benar", benar)
        }
        val nextFragment = soal87Fragment()
    ...
    companion object {
         ...
         * @return A new instance of fragment soal86Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            soal86Fragment().apply {
